...
?>
					<div id="page_browse_mg">
						<div id="page_browse_mg_right" style="width:440px;">
							<div class="greygrad">
								<div class="greygrad2">
									<div class="greygrad3">
									<b><?= $this->lang('terms_signup_title') ?></b>
									</div>
								</div>
							</div>
							<?php { ?>
							<div class="greygrad">
								<div class="greygrad2">
									<div class="greygrad3" align="justify">
										<?= $this->lang('terms_signup_text', array('#SITE_TITLE#'=>$C->SITE_TITLE)) ?>
<div class="klear"></div><div class="klear"></div>
										<a href="<?= $C->SITE_URL ?>terms" class="ubluebtn"><b><?= $this->lang('terms_signup_butt') ?></b></a>
									</div>
								</div>
							</div>
							<?php } ?>
						</div>
						<div id="page_browse_mg_left" style="width:480px;">
		...
		<form method="post" action="">
			<table id="regform" cellspacing="5" style="margin-bottom:10px;">
				...
				<tr>
					<td></td>
					<td>
						<input type="checkbox" name="accept_terms" value="1" <?= $D->accept_terms?'checked="checked"':'' ?> style="float:right;" />
						<div style="float:right; margin-left:5px; margin-top:3px;"><?= $this->lang('signup_step2_form_terms',array('#SITE_TITLE#'=>$C->SITE_TITLE,'#A2#'=>'</a>','#A1#'=>'<a href="'.$C->SITE_URL.'terms" target="_blank">')) ?></div>
						<div class="klear"></div>
					</td>
				</tr>
				<?php } ?>
				<tr>
					<td></td>
					<td><input type="submit" id="signin_submit" value="<?= $this->lang('signup_step2_form_submit') ?>" style="padding:10px; font-weight:bold;" /></td>
				</tr>
			</table>
		</form>
