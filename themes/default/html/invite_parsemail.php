		...
		<div id="invcenter">
			...
			<div id="emailinvites">
				<div id="emailservices">
					...
					<a href="<?= $C->SITE_URL ?>invite/parsemail/tab:yahoo" class="<?= $D->tab=='yahoo'?'onmailservice':'' ?>"><img src="<?= $C->SITE_URL.'themes/'.$C->THEME ?>/imgs/mailservices_yahoo.gif" alt="" /></a>
									...
									<div class="greygrad3" style="padding-bottom:0px;">
										<form method="post" action="">
											<table id="setform" cellspacing="5" >
												...
												<tr>
													<td></td>
													<td><input type="submit" id="signin_submit" value="<?= $this->lang('inv_prsml_gmail_button') ?>" style="padding:10px; font-weight:bold;"/></td>
												</tr>
											</table>
										</form>
									</div>
