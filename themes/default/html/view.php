...
?>
				...
				<center><DIV style="background:url(<?= $C->SITE_URL.'themes/'.$C->THEME ?>/imgs/top--login.png) no-repeat center center; width:931px; height:130px"><div class="not_login"><h3><?= $this->lang('login_text_title') ?> <font size="2px" color="#004096"><?= htmlspecialchars($C->OUTSIDE_SITE_TITLE) ?></font> <?= $this->lang('login_text_title1') ?> <font size="2px" color="#004096"><?= $D->post->post_user->fullname ?></font> <?= $this->lang('login_text_title2') ?></h3><a href="<?= $C->SITE_URL ?>signup"><img class="not_login2" src="<?= $C->SITE_URL.'themes/'.$C->THEME ?>/imgs/not_login_signup_btn.gif" border="0" /></a><h4><?= htmlspecialchars($C->OUTSIDE_SITE_TITLE) ?> <?= $this->lang('login_text_info1') ?> <?= htmlspecialchars($C->OUTSIDE_SITE_TITLE) ?>  <?= $this->lang('login_text_info2') ?></h4></div></DIV></center>
<?php } ?>
		<div id="viewpost">
			<div id="vposthdr">
				<div id="vposthdr2">
					...
					<div class="postcommentsftr2">
						<?php if( $this->user->is_logged ) { ?>
	 					<div class="addpc_big" id="postcomments_<?= $D->post->post_tmp_id ?>_bigform">
							<img src="<?= $C->IMG_URL.'avatars/thumbs3/'.$this->user->info->avatar ?>" class="addpc_avatar" alt="" />
							<div class="addpc_right">
								<textarea id="postcomments_<?= $D->post->post_tmp_id ?>_textarea" onkeyup="textarea_autoheight(this);" onkeypress="not_enter_valid($(this));"></textarea>
