                ...
                <div class="user_box_info" style="width:400px;border-top:solid 3px #752587">
                    <div class="chat">
                                ...
                                <?php foreach ($D->chats as $k) { ?>
                                    <div class="message_box <?= $k['user_id'] == $this->user->id ? 'right' : 'left' ?>">
                                        ...
                                        <div class="message <?= $k['user_id'] == $this->user->id ? 'me' : 'other' ?>">
                                            <?= ($k['message']) ?><br/><small><?= $k['date'] ?></small>
                                        </div>
                                    </div>
                                    <a href="javascript:;" style="float:<?= $k['user_id'] == $this->user->id ? 'right' : 'left' ?>;margin-top:5px;"><img src="<?= $C->SITE_URL .'themes/'.$C->THEME ?>/imgs/delete_chat_msg.gif"/></a>
                                    <div class="klear"></div>
                                <?php } ?>
                        ...
                        <div class="footer_chat">
                            ...
                            <a href="javascript:;" onclick="send_chat_message()" ><div class="send_chat">ارسال</div></a>
                        </div>
                    </div>
                </div>
            </div>
