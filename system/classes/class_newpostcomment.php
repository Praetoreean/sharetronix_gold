				...
				if( $n == 1 ) {
					...
					foreach($notify as $uid=>$n) {
						...
						if( $n == 3 || $n == 1 ) {
							...
							$subject		= $page->lang('emlsubj_ntf_me_if_'.$notifkey, $lng_txt, $ulng);
							$message_txt	= $page->lang('emltxt_ntf_me_if_'.$notifkey, $lng_txt, $ulng);
							$message_htm	= $page->lang('emlhtml_ntf_me_if_'.$notifkey, $lng_htm, $ulng);
