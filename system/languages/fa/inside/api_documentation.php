<?php
	...
	$lang	= array
	(
		'api_doc_page_title'	=> '#SITE_TITLE# - مستندات واسط برنامه نویسی',
		
		'api_doc_menu_title'	=> 'مستنداتِ API',
		
		'api_doc_cat_num' => '16',
		
		'api_doc_cat_1' => 'مقدمه',
		'api_doc_cat_2' => 'پرسش و پاسخ',
		'api_doc_cat_3' => 'وضعیت‌ها',
		'api_doc_cat_4' => 'عناوین کاربران',
		'api_doc_cat_5' => 'پیام مستقیم',
		'api_doc_cat_6' => 'عناوین Friendship',
		'api_doc_cat_7' => 'عناوین اجتماعی',
		'api_doc_cat_8' => 'عناوین حساب‌ها',
		'api_doc_cat_9' => 'عناوین گروه‌ها',
		'api_doc_cat_10' => 'عناوین محبوب',
		'api_doc_cat_11' => 'جستجوهای ذخیره شده',
		'api_doc_cat_12' => 'مکانیزم OAuth',
		'api_doc_cat_13' => 'اطلاعاتِ کاربری',
		'api_doc_cat_14' => 'انجام تست',
		'api_doc_cat_15' => 'جستجو',
		'api_doc_cat_16' => 'گرایشات',
		
		'api_doc_cant_understand' => 'اگر در کار با واسط برنامه نویسی به مسئله ای برخورده اید که ذهنتان را بخود مشغول کرده، با ما در میان بگذارید.',
		'api_doc_contact_us' => 'تماس با ما',
		
		'api_doc_cat_1_post_num' => '8',
		
		'api_doc_cat_1_post_1_title' => 'بررسی واسط برنامه نویسی',
		'api_doc_cat_1_post_1_text' => 'واسط برنامه نویسی [b]#SITE_TITLE#[/b] کاملا" منطبق با [b]Twitter\'s API[/b] طراحی و پیاده سازی شده که به شما این امکان را میدهد تا با ویرایش تنها آدرس برنامه های خود به [b]#SITE_TITLE#[/b]، از آنها استفاده کنید. API امکان دریافت اطلاعات، جستجو، مشاهده‌ی اطلاعات کاربران و در مجموع دریافت و ارسالِ تمامی عملیات اطلاعاتی از طریق برنامه‌ی شما با سایت را ایجاد می‌کند. همچنین API امکان ارسال پست، دیدگاه، حذف دیدگاه، ویرایش اطلاعات پروفایل، گروه ها، لیست علاقه مندی‌ها، مشاهده زنده‌ی ارسال‌ها و جستجوها، پیام‌های مستقیم و کار با اطلاعاتِ بانک اطلاعاتی #SITE_TITLE# را فراهم می‌کند. API تحت استانداردهای برنامه نویسی مانند XML, RSS, JSON و Atom کار می‌کند.',
		
		'api_doc_cat_1_post_2_title' => 'تصدیقِ اطلاعات',
		'api_doc_cat_1_post_2_text' => 'برای کار با تمام بخش‌های #SITE_TITLE# نیاز به تصدیقِ اطلاعات نمی‌باشد. تصدیق و بررسی اطلاعات در مواقعی همچون حذف، ویرایش، افزودن یک رکورد و خواندن اطلاعات شخصی کاربران مورد استفاده قرار می‌گیرد. تصدیقِ اطلاعات تنها در برخی از بخشها نیاز به ورود کاربر به سایت داشته که مواردی همچون ارسال پست و یا خواندنِ پست‌های شخصی را در بر می‌گیرد. این عملیات در بخش Client و توسط پروتکل OAuth (از نظر سطح دسترسی) بررسی میشود.',
		
		'api_doc_cat_1_post_3_title' => 'مکانیزم OAuth',
		'api_doc_cat_1_post_3_text' => '[url=http://apiwiki.twitter.com/Authentication]http://apiwiki.twitter.com/Authentication[/url]
		
OAuth مکانیزمی است که به کاربر اجازه میدهد به داده های خود بدون نیاز به رمز عبور دسترسی داشته باشد. اطلاعات بیشتر در مورد OAuth را در [url=http://www.oauth.net]oauth.net[/url] یا [url=http://hueniverse.com/oauth/]Hueniverse[/url] جستجو کنید. برای ایجاد سطح دسترسی توسط OAuth میتوانید یک برنامه در آدرس [url=#SITE_URL#api]#SITE_URL#api[/url] ایجاد نمایید. این دسترسی‌ها هیچوقت از بین نرفته و منقضی نمی‌شود. در صورتی که یک کاربر به برنامه‌ی خود دسترسی نداشته باشد میتواند یک کد دیگر دریافت نموده و در صورت عدم دسترسیِ مجدد، ممکن است آن برنامه توسط #SITE_TITLE# مسدود شده باشد. لازم به ذکر است که یک برنامه در صورت نقضِ قوانین #SITE_TITLE# در اجرا و خواندن داده‌ها مسدود خواهد شد و این دسترسی حتی با تغییر کدها ممکن نخواهد بود. برای ایجاد دسترسی مجدد باید با تیم مدیریت #SITE_TITLE# هماهنگ نمایید. 
...
بیشتر کاربران تنها برای خواندن ارسال‌ها از برنامه ها استفاده می‌کنند و تعداد کمی از آنها نیاز به ارسال پست دارند. OAuth بر طبق دسترسی گرانول، به برنامه ها سطوح دسترسیِ "فقط خواندنی" یا "خواندن و نوشتن" میدهد. ارسال اطلاعات توسط API، چه یک نام، چه اطلاعات یا ارسال پست، نیاز به ارسالِ HTTP دارد. هر متد API یک درخواست توسط پستِ HTTP  برای "فقط خواندن" یا "خواندن و نوشتن" میفرستد.',
		...
		'api_doc_cat_1_post_4_title' => 'برنامه‌های تحت دسکتاپ',
...
1- برنامه هایی که از OAuth/Request_Token استفاده می‌کنند، مستقیما" دستورها را به #SITE_TITLE# ارسال می‌کنند.
2- درخواست مستقیم کاربر به OAuth/Authorize در #SITE_TITLE#.
3- پس از اخذ تایید کاربر، یک کد 7 رقمی برای تصدیق در #SITE_TITLE# دریافت میشود.
...
&lt /hash&gt[/b]',
		...
		'api_doc_cat_1_post_6_title' => 'کدهای HTTP Status و خطاها',
...
[b]200 OK[/b] : موفقیت آمیز !
[b]304 Not Modified[/b] : داده‌ی جدیدی دریافت نشد.
[b]400 Bad Request[/b] : درخواست ناموفق. (احتمالا" درخواست به مسیر اشتباه ارسال شده یا درخواست با محدودیت مواجه شده است)
[b]401 Unauthorized[/b] :  تصدیقِ دسترسی ناموفق بوده است.
[b]403 Forbidden[/b] : درخواست پردازش شد، اما توسط سرویس دهنده رد شده است. (این کد زمانی استفاده میشود که یک درخواست محدود شده باشد)
[b]404 Not Found[/b] : اشتباه بودن درخواست بخاطر نامعتبر بودنِ لینک یا وجود نداشتنِ کاربر
[b]500 Internal Server Error[/b] : گاها" نمایش داده میشود. (این خطا مربوط به سرویس دهنده بهنگام وقوع مشکل در سرویس نمایش داده میشود)',

		'api_doc_cat_1_post_7_title' => 'کدهای منع کننده و پاسخ‌دهنده',
...
دو پارامتر خاص در استفاده از واسط برنامه نویسیِ [b]#SITE_TITLE#[/b] وجود دارد: 
		
[b]Callback[/b] : فقط در هنگامی که یک درخواست با فرمت JSON ارسال شود مورد استفاده قرار میگیرد. (بعنوان مثال: [b]&callback=myFancyFunction[/b] نتایج درخواست شما را برای myFancyFunction(...) ارسال کرده که فقط بصورت اعداد یا حروف لاتین ارسال شده و بقیه‌ی کاراکترها توسط سرویس دهنده نادیده گرفته میشود)

[b]Suppress_Response_Codes[/b] : اگر این پارامتر را مشاهده کردید، تمام درخواست‌ها با کد [b]200 OK[/b] و بدون هیچ خطایی انجام شده است.',

		'api_doc_cat_1_post_8_title' => 'پیام‌های خطا',
		'api_doc_cat_1_post_8_text' => 'هنگامی که واسط برنامه نویسی #SITE_TITLE# نمی‌تواند یک عملیات را پردازش کند، یک خطا به سرویس دهنده ارسال می‌کند. بطور مثال یک خطا در قالب XML میتواند به شکل زیر باشد:
...
&lt/hash&gt[/b]',
		...
		'api_doc_cat_2_post_1_title' => 'OAuth چیست؟',
...
OAuth نوعی مکانیزم بوده که به کاربر اجازه میدهد تا از برنامه‌ی خود بدون اشتراک گذاشتنِ رمز عبورش استفاده نماید. 
برای اطلاعات بیشتر میتوانید به  [url=http://www.oauth.net]oauth.net[/url] یا  [url=http://hueniverse.com/oauth/]Hueniverse[/url] مراجعه نمایید.',	

		'api_doc_cat_2_post_2_title' => 'برای ایجاد یک برنامه از کجا اقدام کنیم؟',
		'api_doc_cat_2_post_2_text' => '#SITE_URL#api',	
		
		'api_doc_cat_2_post_3_title' => 'مدت دسترسی به Token چقدر است؟',
...
ما معمولا" دسترسی به Token را منقضی نمی‌کنیم. اگر درخواست شما در حالت تعلیق قرار گرفته و یا نامعتبر باشد، میتوانید آنرا از طریق بخش تنظیماتِ برنامه‌ها غیرفعال نموده و یا از طریق بخش ِ مدیریتِ شبکه مسدود نمایید.',	

		'api_doc_cat_2_post_4_title' => 'بخشِ ثبت‌نام به  دسترسی "خواندن و نوشتن" نیاز دارد ؛ دسترسی "نوشتن" چگونه صورت می‌پذیرد؟',
...
Many users trust an application to read their information but not necessarily change their name or post new statuses. Updating information via the [b]#SITE_TITLE#[/b] API - be it name, location or adding a new status - requires and HTTP POST. We stuck with the same restriction when implementing this. Any API method that requires an HTTP POST is considered a write method and requires read & write access.',	
		...
		'api_doc_cat_2_post_5_title' => 'چگونه از الگوریتم‌های رمزنگاری شده استفاده میشود؟',
		...
		'api_doc_cat_2_post_6_title' => 'اجرا سازیِ یک صفحه‌ی امضا شده به چه صورت است؟',
...
5.Nonce [b]MUST[/b] be unique for all requests with that timestamp. A nonce is a random string, uniquely generated for each request.',	
		...
		'api_doc_cat_2_post_7_title' => 'استفاده از OAuth و ساختِ امضا برای هر صفحه لازم است؟ ',
		...
		'api_doc_cat_2_post_8_title' => 'چگونه از API برای برنامه‌های دیگر استفاده کنیم؟',
		'api_doc_cat_2_post_8_text' => 'For url base use the following address: #SITE_URL#1',	
	
		'api_doc_cat_3_post_num' => '15',
		
		'api_doc_cat_3_post_1_title' => 'وضعیت Public_Timeline',
...
[b]Example[/b]: #SITE_URL#1/statuses/public_timeline.json',
		...
		'api_doc_cat_3_post_2_title' => 'وضعیت User_Timeline',
...
[b]Example[/b]: #SITE_URL#1/statuses/user_timeline/1234.json?suppress_response_codes',
		...
		'api_doc_cat_3_post_3_title' => 'وضعیت Mentions',
...
[b]Example[/b]: #SITE_URL#1/statuses/mentions.xml',
		...
		'api_doc_cat_3_post_4_title' => 'وضعیت Private_Mentions',
...
[b]Example[/b]: #SITE_URL#1/statuses/private_mentions.xml',
		...
		'api_doc_cat_3_post_5_title' => 'وضعیت Update',
...
[b]Example[/b]: #SITE_URL#1/statuses/update.xml?status=hello&file=',
		...
		'api_doc_cat_3_post_6_title' => 'وضعیت Group_Update',
...
[b]Example[/b]: #SITE_URL#1/statuses/group_update.xml?status=hello&in_reply_to_status_id=1234',
		...
		'api_doc_cat_3_post_7_title' => 'وضعیت Destory',
...
[b]Example[/b]: #SITE_URL#1/statuses/destroy/1234.xml',
		...
		'api_doc_cat_3_post_8_title' => 'وضعیت Private_Destory',
...
[b]Example[/b]: #SITE_URL#1/statuses/private_destroy/1234.xml',
		...
		'api_doc_cat_3_post_9_title' => 'وضعیت Friends',
...
[b]Example[/b]: #SITE_URL#1/statuses/friends.json?user_id=1234',
		...
		'api_doc_cat_3_post_10_title' => 'وضعیت Followers',
...
[b]Example[/b]: #SITE_URL#1/statuses/followers.json?user_id=1234',
		...
		'api_doc_cat_3_post_11_title' => 'وضعیت Friends_Timeline',
...
[b]Example[/b]: #SITE_URL#1/statuses/friends_timeline.json',
		...
		'api_doc_cat_3_post_12_title' => 'وضعیت Show',
...
[b]Example[/b]: #SITE_URL#1/statuses/show/1234.json',
		...
		'api_doc_cat_3_post_13_title' => 'وضعیت Commented',
...
[b]Example[/b]: #SITE_URL#1/statuses/commented.json?type=public',
		...
		'api_doc_cat_3_post_14_title' => 'وضعیت Comments',
...
[b]Example[/b]: #SITE_URL#1/statuses/comments.xml?post_id=123',
		...
		'api_doc_cat_3_post_15_title' => 'وضعیت Private_Comments',
