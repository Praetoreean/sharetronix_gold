			...
			if( $n == 1 ) {
				...
				foreach($followers as $uid) {
					...
					if( $send_mail ) {
						...
						$subject		= $this->lang('emlsubj_ntf_me_if_u_edt_profl', $lng_txt, $ulng);
						$message_txt	= $this->lang('emltxt_ntf_me_if_u_edt_profl', $lng_txt, $ulng);
						$message_htm	= $this->lang('emlhtml_ntf_me_if_u_edt_profl', $lng_htm, $ulng);
