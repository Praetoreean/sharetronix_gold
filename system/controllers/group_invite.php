	...
	if( isset($_POST['invite_users']) )
	{
		...
		foreach($users as $uid) {
			...
			if( $send_mail ) {
				...
				$subject		= $this->lang('emlsubj_ntf_me_if_u_invit_me_grp', $lng_txt, $ulng);
				$message_txt	= $this->lang('emltxt_ntf_me_if_u_invit_me_grp', $lng_txt, $ulng);
				$message_htm	= $this->lang('emlhtml_ntf_me_if_u_invit_me_grp', $lng_htm, $ulng);
